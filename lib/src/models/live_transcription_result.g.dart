...
part of 'live_transcription_result.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

LiveTranscriptionResult _$LiveTranscriptionResultFromJson(
    ...
    LiveTranscriptionResult(
      ...
      requestParams: json['request_params'] == null
          ? null
          : LiveTranscriptionOptions.fromJson(
              json['request_params'] as Map<String, dynamic>),
      result: json['result'] == null
          ? null
          : LiveTranscriptionResultData.fromJson(
              json['result'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$LiveTranscriptionResultToJson(
        LiveTranscriptionResult instance) =>
    <String, dynamic>{
      'id': instance.id,
